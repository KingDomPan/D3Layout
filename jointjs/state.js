(function() {
  ...
  var stateArray = _.map(['A', 'B', 'C', 'D', 'E'], function(S, index) {
    var num = index + 1;
    return new pn.Place({
      position: {
  ...
  graph.addCell([
    link(stateArray[0], stateArray[1]),
    link(stateArray[1], stateArray[2]),
    link(stateArray[2], stateArray[3]),
    link(stateArray[3], stateArray[4])
  ]);
